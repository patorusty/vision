...
class PolizaController extends Controller
{
    ...
    {
        $poliza = Poliza::where('numero_solicitud', $numero_solicitud)->with(['codigo_productor.productores', 'estado_polizas', 'clientes', 'companias', 'tipo_vigencias', 'endosos.tipo_endoso', 'endosos.detalle_endoso', 'siniestros', 'riesgo_automotor', 'otro_riesgo'])->get();
        return $poliza[0];
    }
