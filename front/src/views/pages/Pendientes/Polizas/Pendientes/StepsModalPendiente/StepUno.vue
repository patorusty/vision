    ...
    <v-card-text>
      <v-container>
        <v-form ref="form">
          <v-row>
            <v-col>
              <div v-if="!poliza.cliente.razon_social" class="text-subtitle-1">
          ...
          <v-row>
            <v-col cols="4">
              <v-text-field label="Poliza Nro:" v-model="poliza.numero">
              </v-text-field>
            </v-col>
          ...
          <v-row>
            ...
            <v-col class="py-0">
              <v-text-field label="Enviado x Mail" :value="dateToString(poliza.fecha_entrega_email)" v-mask="'##/##/####'"
          ...
          <v-row>
            <v-col class="py-0">
              <v-text-field label="Fecha Recepcion" :value="dateToString(poliza.fecha_recepcion)" v-mask="'##/##/####'"
          ...
          <v-row>
            <v-col cols="3">
              <v-text-field v-model="poliza.premio" label="Premio"></v-text-field>
              <v-text-field v-model="poliza.comision" label="Comision"></v-text-field>
            </v-col>
            <v-col cols="3">
            ...
            <v-col>
              ...
              <v-row>
                <v-col class="pt-0">
                  <v-select v-model="poliza.plan_pago" :items="plan_pagos" item-text="value" item-value="value"
                    label="Plan de Pago" :rules="[rules.required]"></v-select>
                </v-col>
                <v-col class="pt-0">
                  <v-text-field v-model="poliza.cantidad_cuotas" label="Cuotas" :rules="[rules.required]"></v-text-field>
                </v-col>
              </v-row>
            </v-col>
          </v-row>
